...
1. [x] Define domain models and interfaces in the Domain project (e.g., `Card`, `Hand`, `Player`, `IRandomProvider`).
2. [x] Implement application logic and use cases in the Application project (e.g., rounds, rules, outcomes).
3. [x] Create infrastructure classes in the Infrastructure project (e.g., `IRandomProvider` implementation, external services).
